<!--
  ...
  Edit THIS file. It is deployed to the kaelys-js/kaelys-js repo by stardust CI
  (.github/workflows/push-kaelys-readme.yml on push to main). It does not
  auto-apply from any other repository — no reconcile note, no external template.
-->
